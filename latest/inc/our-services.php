...
?>
        <section class="services">
			...
			<div class="container">
				...
				<div class="content">
					<h2><?php _e('OUR SERVICES','foliogine-lite'); ?></h2>

					<a href="#" title="" class="box-service">
						<?php if (isset($foliogine_lite_services_image1) && $foliogine_lite_services_image1 != '') : ?>
						...
						<div class="content-text">
							<?php
								if (isset($foliogine_lite_services_title1)):
									echo '<p class="title">'.esc_html($foliogine_lite_services_title1).'</p>';
								endif;
							?>
							<?php
								if (isset($foliogine_lite_services_text1)):
					...
					<a href="#" title="" class="box-service">
						<?php if (isset($foliogine_lite_services_image2) && $foliogine_lite_services_image2 != '') : ?>
						...
						<div class="content-text">
							<?php
								if (isset($foliogine_lite_services_title2)):
									echo '<p class="title">'.esc_html($foliogine_lite_services_title2).'</p>';
								endif;
							?>
							<?php
								if (isset($foliogine_lite_services_text2)):
					...
					<a href="#" title="" class="box-service">
						<?php if (isset($foliogine_lite_services_image3) && $foliogine_lite_services_image3 != '') : ?>
						...
						<div class="content-text">
							<?php
								if (isset($foliogine_lite_services_title3)):
									echo '<p class="title">'.esc_html($foliogine_lite_services_title3).'</p>';
								endif;
							?>
							<?php
								if (isset($foliogine_lite_services_text3)):
					...
					<a href="#" title="" class="box-service">
						<?php if (isset($foliogine_lite_services_image4) && $foliogine_lite_services_image4 != '') : ?>
						...
						<div class="content-text">
							<?php
								if (isset($foliogine_lite_services_title4)):
									echo '<p class="title">'.esc_html($foliogine_lite_services_title4).'</p>';
								endif;
							?>
							<?php
								if (isset($foliogine_lite_services_text4)):
